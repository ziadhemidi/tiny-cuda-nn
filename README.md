...
```sh
pip install git+https://github.com/ziadhemidi/tiny-cuda-nn/#subdirectory=bindings/torch
```
...
> __<https://github.com/KAIR-BAIR/nerfacc>__
...
> __<https://github.com/nerfstudio-project/nerfstudio>__
